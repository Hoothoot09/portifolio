export default function Experience() {
  return (
    <div
      id="experience"
      className="w-full p-2 min-lg:px-50 min-lg:py-10 mb-5 pt-[70px]"
    >
      <h2 className=" max-sm:text-2xl text-3xl text-center text-[#2D2D2D] font-[Georgia] font-bold">
        Experiência
      </h2>
      <p className="max-sm:text-sm text-xl max-sm:text-justify text-center text-[#2D2D2D] font-[Arial] opacity-80 mt-4 p-1">
        ...
        todos os meus conhecimentos, desenvolvendo projeto pessoais com
