    ...
    <div>
      ...
      <div className="">
        ...
        <div className="flex gap-3 mt-4 justify-center items-center">
         <Link href="https://github.com/Hoothoot09?tab=overview&from=2025-05-01&to=2025-05-13"><button><Image src="/github-mark.svg" alt="Github icon" width={30} height={30}/></button></Link>
         <Link href="https://www.linkedin.com/in/andrei-soares/"><button><Image src="/linkedin.svg" alt="linkedin icon" width={30} height={30}/></button></Link>
